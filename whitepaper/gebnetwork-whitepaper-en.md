...
<p>This text describes a decentralized mortgage loan and OTC trade protocol based on Ethereum Blockchain, which will become the open standard and footstone of a global peer-to-peer mortgage loan and OTC trade network, and provide reliable interoperability for DApp based on this protocol. All DApps can execute mortgage loan and OTC trade by embedding a series of free and open smart contract templates in Ethereum. The DApp based on this protocol can obtain transaction orders from its own liquidity pool or shared liquidity pool to make a profit by collecting service charges via married deal. A decentralized network of jurors shall be used for the arbitration of possible transaction disputes, and its fairness shall be ensured by token economic incentive. This protocol shall guarantee no partiality towards either party of the protocol, and no fees to be charged by the protocol itself. A Decentralized Autonomous Organization (DAO) shall be responsible for upgrading as well as its safety and compatibility of the protocol.</p>
...
<p>The digital economy is growing rapidly. An evaluation, made by Boston Consulting Group, is that the potential volume of digital economy in the G20 reached 4.2 trillion US dollars. In addition, another evaluation, based on the joint study made by the Department of Economics of Oxford University and Accenture in 2015, is that the digital economy volume of 1360 billion US dollars shall be contributed to the global gross domestic product by 2020. As the demands for online payment grows with the rapid development of digital economy, cryptocurrency is becoming an increasingly popular payment solution which can meet the demands of digital economy.</p>
...
3. The bank may freeze Tether’s funds.<br />
4. Tether may excessively issue USDT.<br />
...
<p>Another obvious problem in the field of cryptocurrency is that there is no a decentralized service to enable the cryptocurrency holders to safely borrow fiat currency by pledging cryptocurrency, but it has become a noteworthy demand, especially for the users who hold a large amount of cryptocurrency, and believe that the cryptocurrency price will rise. Meanwhile, global investors of fiat currency are also looking for a low-risk and high-yield investment channel, and the mortgage loan market has been in their good graces. The centralized mortgage loan service providers always earning excessive profits via their monopolistic advantage; what’s more, they would also be more easily affected by factors such as market price fluctuation, poor operation and management, inner corruption, regulating policy change etc. In addition, the users’ concern about privacy disclosure risk is also another reason why they transfer to the decentralized service.</p>
...
- Conduct transactions through KYC
- No any third-party intermediary agent is needed to trust for both parties of the transaction, and the security of transaction is guaranteed by the protocol
- The trade protocol is realized by a group of smart contracts (DEX Contracts) deployed on the Ethereum
- Solve the risk that the counterparty viciously withdraws from the transaction by the smart contract with time lock (Timelock Contract)
...
<p>GEB Network is an open source project to fill up the gap of cryptocurrency ecological system rather than a company. GEB Foundation is a non-profit organization established by GEB team in Singapore in June, 2018. The purpose of establishing GEB Foundation is to guarantee the sustainability of GEB project, the effectiveness of decentralized governance, the safety and transparency of fund raising, and the development and business innovation of assisting start-up enterprises based on GEB protocol.</p>

<p>To promote the healthy development of GEB Network, a comprehensive incentive mechanism has been estanlished by GEB Foundation, mainly including:</p>
...
<p>Both parties of the transaction agree on volume, price, time and location of transaction through softwares, such as Facebook, Telegram, WeChat, QQ etc., without the involvement of any third party. This method is applicable to the local transaction with relatively high fund security risk, and even personal safety risk. Due to the anonymity of cryptocurrency, once a party violates the protocol, the other party’s rights and interests are difficultly guaranteed; what’s more, it is difficult to get and present evidence after such situation. Except in few countries where cryptocurrency transaction is included into the regulatory framework by issuing license, most countries and regions have no legal protection for cryptocurrency transaction, which also increase the possibility that the trader may suffer from fraud risk.</p>

### 2.2. Centralized OTC Exchange
<p>The OTC trading platforms, such as Localbitcoins, otcbtc, huobi etc., provide the C2C cryptocurrency/fiat currency transaction service, which is a secured trading mode similar to Ebay and Taobao. The seller of cryptocurrency transfer a certain number of cryptocurrency to the address provided by the trading platform, while the buyer fills in and submits an order for purchasing, and the fiat currency should be transferred to the account designated by the seller. After the seller confirms that the fiat currency has been account, the trading platform shall transfer the cryptocurrency to the buyer’s address. Any dispute happening during the transaction shall be arbitrated by the trading platform.</p>
...
| Role | Advantage |
| :--------------------- | :------------------------------ |
| OTC trader | whenever and wherever possible, conduct an OTC transaction with any counterparty with conveniently, quickly and lower cost |
| Borrower | Obtain fiat currency loan with a low interest rate by mortgaging digital currency |
...
| Juror | Obtain token rewards by arbitrating the disputes that cannot be solved through smart contracts |
...
|    Safety    |    ***High (guaranteed by smart contracts)***    |  High (guaranteed by smart contracts)   |   Medium (need to trust the platform)   |   Medium (need to trust the institution)   |   Medium (need to trust the institution)   |  Medium (need to trust the platform)  |
...
| Off-chain dispute solution |    ***Decentralized juror network***     |      No       |      Streamline arbitration      |       No        |       No        |      No       |
...
### 3.4. Black Swan Event
<p>Black swan event refers to unpredictable and unusual event. and usually arouses negative market chain reaction, and even overthrow. Cryptocurrency market is characterized with huge fluctuation, so we must consider an extreme situation: the price of a mortgage token falls rapidly in a short time, and the collateral price has drastically fallen below the debt amount before DEX Contract has time to execute the compulsory liquidation. Under such circumstance, to prevent the extending of risk exposure, DEX Contract will automatically execute compulsory liquidation immediately, and ask GEB ERC20 Contract to additionally issue a certain number of GEB in accordance with the market price of GEB Token to the lending party to compensate the difference between collateral value and debt amount. Such additional issue mechanism may cause a certain degree of value dilution to GEB Token, but compared with the damage on GEB Network caused by large-scale debt default, such value dilution is mild and controllable, and conforms to long-term interests of most GEB Token holders.</p>

<p>If the cryptocurrency market price fluctuates sharply, GEB DAO committee has the right to remove certain types of cryptocurrency out of the scope of token types which can be mortgaged, and even temporarily shut down the mortgage loan business in the whole network. The main business system of GEB Network is established totally based on the ecological system of Ethereum and bitcoin (it may be extended to EOS in the future), therefore the safety and practicality of GEB Network and the price of GEB Token shall depend on the health degree of the ecological system of Ethereum and bitcoin to a large extent. In the long term, GEB team shall pay close attention to the development orientation of blockchain underlying technology, and GEB Network shall benefit from the prosperity of the whole cryptocurrency ecology, and thus gain a sustainable and healthy development.</p>
...
### 3.6. Non-Ethereum Cryptocurrency Compatibility
...
<p>The lightning atomic swap is a real-time cross-chain transaction technology combining lightening network and atomic swap. The lightening network is a protocol which operates by establishing off-chain payment channel between different trades, and the on-chain transaction is only need to open and close the payment channel. It has three advantages. First, accelerate transaction velocity; second, reduce transaction cost; and third, promote transaction volume. The atomic swap is another protocol which enable both parties to conduct the cross-chain transaction without the need of trust. There are two results for the execution of atomic swap. The one is that both parties complete the digital currency exchange, and the other is that nothing happens. Most importantly, there is no need of trusting any third party, so it can avoid fraud.</p>
...
- Users paying OTC trade service charges with GEB Tokens can enjoy 50% discount.
...
### 4.5. First Token Release

#### 4.5.1. Token Release Plan - DAICO
...
#### 4.5.3. Withdrawals
<p>After the sale of crowdfunding ends, the Fund contract was converted to the Team Withdraw mode, allowing the project team to regularly withdraw a limited amount of funds raised. Funds raised through the Fund contract can be paid to the development team by the following two approaches:</p>

- Limited direct payment (first withdrawal)
<p>Taking into account the high volatility of ETH prices, the team may withdraw half of the funds raised immediately after the sale of crowdfunding ends and convert it to fiat currency or DAI to protect the project.</p>

- Payment based on TAP mode
<p><b>Tap (wei/s): </b>This is the maximum amount that the project team can reasonably extract from Fund contract every month. The initial Tap is set to 77160493827160 (wei/s) = 200 ETH/month by the smart contract. Tap is used to support the long-term development of the platform. Tap will continue to accumulate if it does not pay.</p>

<p><b>Tap Increase: </b>If the team needs more money for any reason, it can initiate a vote to increase Tap. Token holders can vote based on the number of tokens they keep on their wallet (N, where N≠0) on whether to authorize the team to spend additional funds. The vote to increase Tap will be conducted on the 1st of each month. If the number of "agree" votes exceeds that of "disagree", the vote is deemed to be successful. Voting will start immediately after it is initiated and last for 3 days. In order to prevent damage to the system, the percentage that Tap can be increased at a time will be limited to 50% of the initial amount. After the vote is closed, the vote will be no longer accepted. And the holder who did not vote is deemed as "agreed" by default. (Increase the TAP voting prevention (Proof-of-Stake algorithm) Protocol, aiming to prevent holders of large amount of tokens from voting maliciously, such as exchanges, etc. The proportion of vote for each Ethereum wallet is limited to a certain number of tokens. (Voting weight <= 0.5% of all tokens.) Tokens that are locked by smart contracts have no voting rights, such as locked portion for teams, funds, and reservations. Because it is controlled by the smart contract, not by human will.)</p>

<p><b>Refund Vote: </b>If the token holders are dissatisfied with the team work of the project (and consider that the team failed to perform the project), they can request a refund vote. The refund vote is initiated by the team once every six months, which will start immediately and last for one week. Refund activities will continue to be available for the first two years after the end of the token sale. If the number of votes for "agree" in the refund vote exceeds that of "disagree", the vote is considered to be successful. Voting will start immediately after it is initiated and last for 1 week, and voting results can be changed at any time during the voting period. After the vote is closed, the vote will be no longer accepted. And the holder who did not vote is deemed as "disagreed" by default.  If the refund vote is successful, the token holder shall keep the token and do not transfer it to another ETH wallet before the first day of the next month. In this case, the vote will be deemed as completed. If the token is transferred, the current voting right of the token holder will be reduced. For example, if one person invested 1000 tokens and moved 500 of them to another wallet, his voting weight will be reduced to 500 instead of 1000. We will calculate the final voting result based on the actual transfer of tokens on the first day of the month following the successful refund vote. If the first refund vote is successful, the team's withdrawal will be locked, and the second refund vote shall be conducted within one month. Similar to the first vote, our second voting time is also one week. Voting results can be changed at any time during the voting period. After the vote is closed, the vote will be no longer accepted. If the second refund vote is successful, the token holder can return the remaining funds. If it is unsuccessful, the team's withdrawal is unlocked. This two-stage voting system is designed to protect the project from affecting the hasty decision of the token holders caused by the rapid changes in the cryptocurrency market. If the refund is performed, the current GEB/ETH exchange rate is calculated by dividing the remaining ETH of the current fund account by the total amount of tokens after the tokens of the team, reservation, and fund have been destroyed. And then return funds to the token holders according to this rate. (Refund voting prevention (Proof-of-Stake algorithm) Protocol, aiming to prevent holders of large amount of tokens from voting maliciously, such as exchanges, etc. The proportion of vote for each Ethereum wallet is limited to a certain number of tokens. (Voting weight <= 0.1% of all tokens.) Tokens that are locked by smart contracts have no voting rights, such as locked portion for teams, funds, and reservations. Because it is controlled by the smart contract, not by human will.)</p>
...
<p>The OTC and collateral lending in the GEB Network have realized the conversion between Token and fiat currency. Therefore, when performing a transaction, we should consider the frequently occurring problem that is the mismatch between the irreversibility of the Blockchain encryption assets transfer and the retractability of many methods of fiat currency payment. Common payment methods and their transaction reversion:</p>
...
<br /><br />
## 7. Market Analysis
### 7.1. The Present Situation of Cryptocurrency Market
<p>According to CoinMarketCap’s research, in September 2017, the average daily trading volume of the cryptocurrency has exceeded $4 billion, and the total market value of the cryptocurrency market has exceeded $13 billion. However, the cryptocurrency market is still small compared with the global legal currency transactions. For example, the trading volume of the global foreign exchange market assessed by the BIS is $5.1 trillion. According to the current growth rate of the cryptocurrency, it is probable that the similar trading volume with the foreign exchange market will be achieved within the next three years. Because we will soon live in a reality dominated by digital currency.</p>
...
<p>Wei Zhu, a Blockchain and artificial intelligence preacher as well as a growth hacker and lifelong learner, has gained a bachelor degree in Microelectronics from Fudan University and has a 10-odd-year experience in technology R&D and technology management in the Internet industry.  Xinpu IT consulting was founded by him, which is the country's earliest enterprise to engage in Blockchain technical consulting. He was the chief architect of Qihoo 360 WiFi business, Technology Director of DeNA China, and presided over R&D management of 100 million level user products, who is the pioneer of technological innovation advocating the restructuring of the Internet infrastructure from the protocol layer with deep research and unique insight into the theory of Blockchain, distributed computing, event tracing, Turing calculation, deep study and so on.</p>

- CTO: Ching Zhu

<p>Ching Zhu, the founder of the chainboard. io, who has obtained the highest honors of Electronic Science and Technology University—— "Outstanding Student", served as the Bingjian scientific and technical Director of the famous Fintech company designing and leading the research and development of wind-control integrated platform and large-scale data platform and thus accumulating rich experience in the design of internet and wind-control model, and the research and development of micro-service system architecture. In 2016, she began to lead the team to master and successfully develop the industry application based on Blockchain technology, and participate in the operation of the Blockchain project of the listed company. She has served as a special technical consultant to provide architectural consulting and design to a number of listed companies and has shared the theme among several well-known technical forums as a lecturer.</p>

- CPO: Jeremy Lan

<p>Jeremy Lan, the co-founder and CTO of Hardrole and a senior Blockchain engineer, who is interested in logic and strategic research and has rich experience in internet practice and deep technical insight, has been in charge of cloud architecture design and product development in Hiscene which is a well-known artificial intelligence company. Immersed in the Blockchain field for many years, he is familiar with the Blockchain underlying technology, multi-currency wallet and exchange, as well as all kinds of safety protection. In addition, he also participated in Metaverse Blockchain development and is the Core Team member. At present, he commit himself to actively explore and settle the problems in the project such as scalability of Blockchain and the ordering scheme of DAG partial sequence network.</p>

- COO: Yuanfei Zhu

<p>As early as during the middle school period, with excellent performance in the computer/physics competition, he was sent to the Shanghai Jiao Tong University pilot class to specialize in computer science and technology. During the university, he took the initiative to drop out of school to create Moregg, and thus gained a lot of achievements from zero to one while achieving outstanding result. After graduating in Silicon Valley, he was mainly engaged in online advertising, marketing, big data and machine learning algorithms under the securities scene, and accumulated rich data analysis and operation experience at Yahoo. Since participating in Blockchain project development in 2016, as an early developer of Ethereum, while pursuing the bottom technology of the Blockchain, he also participated in the high-performance exchange architecture design, operated the ico-generation platform Beico, and successfully completed a series of smart contracts-based projects such as ENS. In 2017, Satori was established in Singapore and a professional team was built to provide world-class services such as overseas compliance for funds and foundations. The partners that have served and cooperated with in depth include IOST, ZJL, TNC, etc.
</p>

- CFO: Chun Jiang

<p>Chun Jiang, who graduated from Fudan University and obtained a master degree in International Trade and Economics from Duke University. She once worked as a financial analyst at Morgan Stanley in London, and once served in the World Bank engageing in global value chain research for analyzing the impact of China's economic and financial policies on industrial chain upgrading and globalization.
</p>

- Overseas Market Operation Officer: Amira Zhou
Amira Zhou, who possesses seven years of experience in business negotiation and project management in overseas markets, once worked in Dina Technology which is a well-known car networking company, and was responsible for the overseas market business. During her tenure, she introduced tens of millions of cooperation projects of Malaysian operators for the company, created the first case of domestic car networking companies to provide overseas operators with integrated solutions including the car networking big data platform and hardware. As a senior English interpreter, she once served as a simultaneous interpreter at the Shanghai G20 Finance Ministers' Meeting. Currently, she is focused on industry research and market operations related with cryptocurrency investment and Blockchain with extensive experience in overseas business and project operations.
...
<p>Benjamin Gu, the chief strategy officer of DAEX and the Chairman of the foundation as well as MBA of the University of Texas, master of the University of Notre Dame, master of China University of Science and Technology, bachelor of Shandong University, who is the Former Deputy Chief Information Technology Officer of Huatai United Securities and Chief Operating Officer of several financial services companies, has working experience in senior management and R&D in the well-known Internet finance companies in China and the United States, and was previously responsible for the development and operation of ENCORE which is the sole clearing system for the US options trading market in the U.S. Options Clearing Company.</p>

- Yang Zhao

<p>Yang Zhao, the Chief Operating Officer of Shanghai Xinyan Credit Information Service Co., Ltd., who was once the Vice President of Tianyi Credit Information Co., Ltd. and has many years of business experience in how telecom operators use data for credit reporting and risk control, has led the team to jointly found Shanghai Xinyan Credit Information Service Co., Ltd. which rapidly rises relying on the professional products and high quality servicesto deeply  plough  inthe field of big data risk control. </p>
