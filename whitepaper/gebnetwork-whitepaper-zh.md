...
  Hardrole联合创始人兼CTO，资深区块链工程师。爱好逻辑学与战略研究，有着丰富的互联网从业经验和深刻的技术洞见，曾在著名人工智能公司Hiscene负责云架构设计与产品开发。在区块链领域浸泡多年，熟悉区块链底层，多币种钱包和交易所等技术以及各类安全防护。此外，还参与了Metaverse Blockchain开发，是Core Team成员。目前正积极研究区块链扩容和DAG偏序网络结构下定序等方案的工程方面的问题。<br />
